                ...
                <table class="w-full min-w-[400px]">
                    <thead>
                        <tr class="text-left text-xs uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">
                            ...
                            <th class="px-4 py-2 text-gray-500 dark:text-gray-400 text-right">Montant</th>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 flex flex-col">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4 flex-shrink-0">
                <div class="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <div class="text-2xl font-bold text-blue-600 dark:text-blue-400" id="today-sales">0,00 DH</div>
                    <div class="text-xs text-gray-500 dark:text-gray-400 uppercase mt-1">Aujourd'hui</div>
                </div>
                <div class="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <div class="text-2xl font-bold text-green-600 dark:text-green-400" id="week-sales">0,00 DH</div>
